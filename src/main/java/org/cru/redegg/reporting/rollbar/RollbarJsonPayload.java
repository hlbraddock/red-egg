 ...
 * @author Matt Drees
 */
public class RollbarJsonPayload implements Payload
{
    ...
    public RollbarJsonPayload(ErrorReport report, RollbarConfig config, FileNameResolver resolver)
    {
        this.report = report;
        this.config = config;
    ...
    public RollbarJsonPayload prettyPrint()
    {
        prettyPrint = true;
        return this;
    }
